...
-- ============================================================
-- SEED: Events (4 eventos realistas para apresentação)
-- ============================================================

-- Limpeza de dados dependentes para evitar FK violations ao recriar o seed
...
VALUES
    ...
    (2, 'Oktoberfest na Serra',
     ...
     'https://images.unsplash.com/photo-1559523161-0fc0d8b3a50e?w=800&q=80', 1, 'Published', 4, 4, datetime('now')),
    ...
    (3, 'Turnê Jão - Super',
     ...
     'https://images.unsplash.com/photo-1493225255756-d95c46399e9e?w=800&q=80', 1, 'Published', 1, 4, datetime('now')),
...
INSERT INTO Orders (Id, UserId, EventId, OrderCode, TotalAmount, Status, PaymentMethod, CreatedAt, ConfirmedAt)
VALUES
    (1, 2, 1, 'BA-20240601-A1B2C3D4', 100.00, 'Confirmed', 'Pix', datetime('now', '-3 days'), datetime('now', '-3 days'));

INSERT INTO OrderItems (Id, OrderId, TicketTypeId, Quantity, UnitPrice, Subtotal)
VALUES
