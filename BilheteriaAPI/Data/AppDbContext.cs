...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Usuario>().HasData(
            new Usuario { Id = 1, Nome = "Administrador", Email = "admin@bilheteria.com", SenhaHash = "$2a$11$Sj6FFqXRMKbqptoNe8/ESuTzs5q2ar5H2NrCBsw4TBfUka1eGXosm", Tipo = "Admin" },
            new Usuario { Id = 2, Nome = "Cliente Teste", Email = "cliente@email.com", SenhaHash = "$2a$11$pUX86BEuYqjBB.AU/12rnOv.u3R7YWB5.e8ndOI8g6noHjnO66Ruq", Tipo = "Cliente" }
        );

        // Seed: eventos iniciais
        modelBuilder.Entity<Evento>().HasData(
            new Evento { Id = 1, Nome = "Show de Rock 2024", Descricao = "O maior show de rock do ano com bandas internacionais!", Data = new DateTime(2025, 8, 15, 20, 0, 0), Local = "Arena Unifeso", ImagemUrl = "🎸" },
            new Evento { Id = 2, Nome = "Festival de Música Eletrônica", Descricao = "Uma noite inesquecível com os melhores DJs do mundo", Data = new DateTime(2025, 9, 5, 22, 0, 0), Local = "Clube Teresópolis", ImagemUrl = "🎧" },
            new Evento { Id = 3, Nome = "Teatro: A Comédia dos Erros", Descricao = "Peça clássica de Shakespeare com elenco renomado", Data = new DateTime(2025, 7, 20, 19, 0, 0), Local = "Teatro Municipal", ImagemUrl = "🎭" }
        );
